...
public class MenuTypeRegister {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, HyperiosMod.MODID);

    public static final RegistryObject<MenuType<MythrilCondenserMenu>> MYTHRIL_CONDENSER_MENU = registerMenuType(MythrilCondenserMenu::new, "mythril_condenser_menu");
